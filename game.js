...
const CURATED_ROOM_DESIGNS = {
    // Prologue: calibrate the harder jump and dash language over two checkpoints.
    prologue: {
        name: 'Prologue - First Steps', spawn: [16,146],
        terrain: [[0,160,80,24],[120,160,72,24],[232,160,88,24],[32,128,48,32],[120,112,40,24],[192,88,40,24],[264,64,56,24],[184,40,48,16],[96,16,56,16]],
        spikes: [[56,152,3,'up'],[120,152,2,'up'],[120,104,3,'up'],[192,80,3,'up'],[264,56,2,'up']],
        berries: [[288,148,'prologue-secret-steps']],
        exit: [120,0,'prologue-ascent']
    },
    'prologue-ascent': {
        spawn: [16,146],
        terrain: [[0,160,64,24],[112,160,56,24],[224,160,96,24],[24,128,40,24],[96,104,40,24],[168,80,40,24],[240,56,80,24],[168,32,40,16],[88,8,48,16],[16,80,24,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,3,'up'],[96,96,3,'up'],[168,72,3,'up'],[240,48,2,'up']],
        movers: [[64,136,24,8,88,136,40]],
        berries: [[24,64,'prologue-hidden-ledge']],
        exit: [112,0,'forsaken']
    },

    // Forsaken City: long jumps, mover timing, then a cassette reversal route.
    forsaken: {
        name: 'Forsaken City - Broken Streets', spawn: [16,146],
        terrain: [[0,160,72,24],[128,160,48,24],[224,160,96,24],[24,128,48,32],[128,112,40,24],[200,88,40,24],[264,64,56,24],[184,40,40,16],[96,8,48,16],[16,72,24,16]],
        spikes: [[48,152,3,'up'],[128,152,2,'up'],[24,120,3,'up'],[128,104,3,'up'],[200,80,3,'up'],[264,56,2,'up']],
        berries: [[24,56,'city-secret-alley']],
        exit: [120,0,'forsaken-crossing']
    },
    'forsaken-crossing': {
        name: 'Forsaken City - Broken Crossing', spawn: [16,146],
        terrain: [[0,160,56,24],[248,160,72,24],[64,128,32,16],[136,120,40,16],[208,104,32,16],[96,72,32,16],[168,56,32,16],[264,48,40,16],[16,88,24,16],[120,24,40,16]],
        spikes: [[64,120,2,'up'],[216,96,2,'up'],[272,40,2,'up']],
        movers: [[56,140,32,8,244,140,42],[100,84,24,8,196,84,55]],
        exits: [[128,0,'forsaken-rooftops'],[304,148,'forsaken-underpass','right']]
    },
    // Optional subterranean skip: dash-bridged pits, a Kevin overhang and a
    // side berry. Links crossing straight to the tower.
    'forsaken-underpass': {
        name: 'Forsaken City - Underpass', spawn: [16,146],
        terrain: [[0,160,64,24],[96,160,48,24],[176,160,48,24],[264,160,56,24],[40,128,32,16],[112,104,32,16],[184,80,32,16],[256,40,40,16],[272,16,32,8]],
        spikes: [[40,120,1,'up'],[112,96,1,'up'],[184,72,1,'up'],[256,32,1,'up']],
        kevin: [[232,118,24,24]],
        gate: [[68,150,26,8],[226,150,36,8]],
        switches: [[52,112,[[68,150],[226,150]]]],
        berries: [[292,132,'city-secret-underpass']],
        exit: [284,0,'forsaken-tower']
    },
    'forsaken-rooftops': {
        spawn: [16,146],
        terrain: [[0,160,64,24],[104,160,64,24],[224,160,96,24],[24,120,40,40],[104,96,40,24],[184,72,40,24],[264,48,56,24],[176,24,40,16],[88,16,48,16],[16,72,24,16]],
        spikes: [[40,152,3,'up'],[104,152,2,'up'],[24,112,3,'up'],[104,88,3,'up'],[184,64,3,'up'],[264,40,2,'up']],
        movers: [[64,128,24,8,88,128,46]],
        berries: [[24,56,'city-secret-billboard']],
        exit: [112,0,'forsaken-tower']
    },
    'forsaken-tower': {
        spawn: [16,146],
        terrain: [[0,160,80,24],[128,160,56,24],[240,160,80,24],[40,128,40,32],[112,104,40,24],[184,80,40,24],[256,56,64,24],[176,32,40,16],[96,8,48,16],[16,48,24,16]],
        spikes: [[56,152,3,'up'],[128,152,2,'up'],[40,120,3,'up'],[112,96,3,'up'],[184,72,3,'up'],[256,48,3,'up']],
        cassette: [64,118,'cassette-city','forsaken-bside'],
        exit: [120,0,'old-site']
    },

    // Old Site: isolated dreamlike landings and a pressure chase.
    'old-site': {
        name: 'Old Site - Dream Gate', spawn: [16,146],
        terrain: [[0,160,64,24],[120,160,48,24],[224,160,96,24],[32,128,32,32],[104,104,32,24],[176,80,32,24],[248,56,72,24],[176,32,32,16],[96,8,48,16],[16,72,24,16]],
        spikes: [[40,152,3,'up'],[120,152,2,'up'],[32,120,2,'up'],[104,96,2,'up'],[176,72,2,'up'],[248,48,3,'up']],
        dream: [[72,120,24,16],[144,88,24,16]],
        berries: [[24,56,'oldsite-secret-memory']],
        exit: [120,0,'old-site-dream']
    },
    'old-site-dream': {
        spawn: [16,146],
        terrain: [[0,160,48,24],[104,160,48,24],[208,160,112,24],[24,128,24,32],[96,104,24,24],[168,80,24,24],[240,56,80,24],[168,32,32,16],[80,8,48,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,96,2,'up'],[168,72,2,'up'],[240,48,3,'up']],
        dream: [[48,120,32,16],[128,88,32,16],[200,64,32,16]],
        movers: [[48,136,16,8,80,136,38]],
        exit: [104,0,'old-site-depths']
    },
    'old-site-depths': {
        spawn: [16,146],
        terrain: [[0,160,56,24],[112,160,48,24],[224,160,96,24],[24,128,32,32],[112,112,32,24],[192,88,40,24],[264,64,56,24],[184,40,40,16],[96,16,48,16],[16,80,24,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,120,1,'up'],[112,104,2,'up'],[200,80,3,'up'],[264,56,2,'up']],
        springs: [[32,120,2]], movers: [[56,112,24,8,88,112,38],[144,80,24,8,176,80,40]],
        berries: [[24,64,'oldsite-secret-basement']],
        exit: [120,0,'old-site-chase']
    },
    'old-site-chase': {
        spawn: [16,146],
        terrain: [[0,160,72,24],[120,160,48,24],[224,160,96,24],[40,128,32,32],[112,104,32,24],[176,80,32,24],[240,56,80,24],[176,32,32,16],[96,8,48,16],[272,40,32,16]],
        spikes: [[48,152,3,'up'],[120,152,2,'up'],[40,120,2,'up'],[112,96,2,'up'],[176,72,2,'up'],[240,48,3,'up']],
        badelines: [[280,120]],
        cassette: [280,26,'cassette-oldsite','old-site2'],
        exit: [120,0,'resort']
    },

    // Resort: narrow service platforms, spring routing, and timed machinery.
    resort: {
        name: 'Celestial Resort - Service Entrance', spawn: [16,146],
        terrain: [[0,160,80,24],[128,160,40,24],[224,160,96,24],[32,128,40,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[176,32,32,16],[88,8,48,16],[16,72,24,16]],
        spikes: [[56,152,3,'up'],[128,152,2,'up'],[32,120,2,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        springs: [[48,120,2]],
        berries: [[24,56,'resort-secret-laundry']],
        exit: [112,0,'resort-lobby']
    },
    'resort-lobby': {
        name: 'Celestial Resort - Grand Lobby', spawn: [16,146],
        terrain: [[0,160,64,24],[112,160,48,24],[224,160,96,24],[80,128,32,16],[152,112,32,16],[232,88,40,16],[160,64,32,16],[88,40,32,16],[184,24,40,16],[280,120,32,16],[232,48,24,12]],
        spikes: [[48,152,2,'up'],[128,152,2,'up'],[286,112,2,'up'],[104,32,2,'up'],[220,16,1,'up']],
        springs: [[32,144,1],[144,96,2]], kevin: [[256,72,24,32]],
        exit: [192,0,'resort2']
    },
    resort2: {
        name: 'Celestial Resort - Presidential Suite', background: 'resort', spawn: [16,146],
        terrain: [[0,160,64,24],[112,160,48,24],[216,160,104,24],[24,128,40,32],[112,104,32,24],[184,80,40,24],[264,56,56,24],[184,32,40,16],[96,8,48,16],[280,112,24,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,1,'up'],[112,96,2,'up'],[184,72,3,'up'],[264,48,2,'up']],
        springs: [[32,120,1]], bubbles: [[200,58,9,'#6ef3ef']],
        berries: [[288,96,'resort-secret-suite']],
        gate: [[228,100,50,8]],
        switches: [[188,16,[[228,100]]]],
        exit: [120,0,'resort-finale']
    },
    'resort-finale': {
        name: 'Celestial Resort - Rooftop', spawn: [16,146],
        terrain: [[0,160,72,24],[128,160,40,24],[224,160,96,24],[40,128,32,32],[112,104,32,24],[176,80,32,24],[240,56,80,24],[176,32,32,16],[96,8,48,16],[16,48,24,16]],
        spikes: [[48,152,3,'up'],[128,152,2,'up'],[40,120,2,'up'],[112,96,2,'up'],[176,80,2,'left'],[240,48,3,'up']],
        movers: [[72,112,24,8,88,112,44],[144,72,24,8,176,72,46]],
        cassette: [20,34,'cassette-resort','resort-bside'],
        exits: [[120,0,'mirror'],[296,136,'resort-cellars','right']]
    },
    // Optional descent detour off the rooftop: drop in from the top right,
    // ride bubbles/springs down through the old cellars, leave with a berry.
    'resort-cellars': {
        name: 'Celestial Resort - Old Cellars', spawn: [288,20],
        terrain: [[240,32,80,16],[168,56,56,16],[96,80,56,16],[32,104,48,16],[88,136,64,24],[192,144,128,40]],
        spikes: [[168,48,3,'up'],[96,72,3,'up'],[200,136,3,'up'],[280,152,2,'up']],
        springs: [[52,96,1]], bubbles: [[224,92,9,'#6ef3ef'],[140,116,9,'#6ef3ef']],
        berries: [[24,124,'resort-secret-vintage']],
        exit: [296,120,'resort-finale']
    },


    // Mirror Temple: bubble commitments, enemy pressure, and route reversals.
    mirror: {
        name: 'Mirror Temple - Entrance', background: 'mirror', spawn: [16,146],
        terrain: [[0,160,56,24],[120,160,40,24],[224,160,96,24],[24,128,32,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[184,32,32,16],[96,8,48,16],[16,72,24,16]],
        spikes: [[32,152,3,'up'],[120,152,2,'up'],[24,120,2,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        bubbles: [[80,116,10,'#a879ff'],[160,84,10,'#a879ff'],[236,52,10,'#a879ff']],
        berries: [[24,56,'mirror-secret-entrance']],
        exit: [120,0,'mirror-depths']
    },
    'mirror-depths': {
        spawn: [16,146],
        terrain: [[0,160,64,24],[112,160,40,24],[208,160,112,24],[24,128,40,32],[104,104,32,24],[176,80,32,24],[248,56,72,24],[176,32,32,16],[88,8,48,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,3,'up'],[104,96,2,'up'],[176,72,2,'up'],[248,48,3,'up']],
        bubbles: [[80,112,9,'#aa82ff'],[152,76,9,'#aa82ff'],[224,44,9,'#aa82ff']], seekers: [[280,104]],
        exit: [112,0,'mirror-sanctum']
    },
    'mirror-sanctum': {
        spawn: [16,146],
        terrain: [[0,160,72,24],[128,160,40,24],[224,160,96,24],[40,128,32,32],[120,104,32,24],[192,80,32,24],[264,56,56,24],[184,32,40,16],[96,8,48,16],[16,80,24,16]],
        spikes: [[48,152,3,'up'],[128,152,2,'up'],[40,120,2,'up'],[120,96,2,'up'],[192,72,2,'up'],[264,48,2,'up']],
        movers: [[72,112,24,8,96,112,46]], bubbles: [[232,58,10,'#a879ff']], seekers: [[280,112]],
        berries: [[24,64,'mirror-secret-sanctum']],
        exit: [120,0,'mirror-temple']
    },
    'mirror-temple': {
        name: 'Mirror Temple - Escape', spawn: [16,146],
        terrain: [[0,160,64,24],[120,160,40,24],[224,160,96,24],[32,128,32,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[184,32,32,16],[96,8,48,16],[272,40,32,16]],
        spikes: [[40,152,3,'up'],[120,152,2,'up'],[32,120,2,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        badelines: [[280,120]], bubbles: [[224,60,9,'#a879ff']],
        cassette: [280,26,'cassette-mirror','mirror-bside'],
        exit: [120,0,'summit']
    },

    // Summit: ice braking, wind reading, then a compact flag-style finale.
    summit: {
        name: 'The Summit - Snowline', spawn: [16,146], ice: true,
        terrain: [[0,160,80,24],[128,160,40,24],[224,160,96,24],[32,128,40,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[176,32,40,16],[88,8,48,16],[16,72,24,16]],
        spikes: [[56,152,3,'up'],[128,152,2,'up'],[32,120,2,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        springs: [[48,120,2]],
        berries: [[24,56,'summit-secret-snowbank']],
        exit: [112,0,'summit-ridge']
    },
    'summit-ridge': {
        name: 'The Summit - Razor Ridge', spawn: [16,146], ice: true,
        terrain: [[0,160,72,24],[136,160,48,24],[232,160,88,24],[88,124,32,20],[160,108,32,16],[224,84,32,20],[176,56,32,16],[104,36,32,16],[40,16,40,16]],
        spikes: [[56,152,2,'up'],[152,152,2,'up'],[104,28,2,'up'],[184,48,2,'up'],[248,76,2,'up']],
        wind: [40,16,240,120,-1,38],
        exit: [48,0,'summit-gale']
    },
    'summit-gale': {
        spawn: [16,146], ice: true,
        terrain: [[0,160,64,24],[112,160,40,24],[216,160,104,24],[24,128,32,32],[104,104,32,24],[176,80,32,24],[248,56,72,24],[176,32,32,16],[88,8,48,16],[280,112,24,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,2,'up'],[104,96,2,'up'],[176,72,2,'up'],[248,48,3,'up']],
        bubbles: [[80,114,9,'#d9fbff'],[156,76,9,'#d9fbff'],[228,44,9,'#d9fbff']], wind: [48,24,240,120,-1,36],
        feather: [40,96],
        berries: [[288,96,'summit-secret-weather-station']],
        gate: [[60,132,40,8]],
        switches: [[40,112,[[60,132]]]],
        exit: [112,0,'summit-aurora']
    },
    // Feather-glide showcase: grab the feather low, then surf the gale up a
    // sparse ladder of icy shelves toward the aurora berry.
    'summit-aurora': {
        name: 'The Summit - Aurora Crossing', spawn: [16,146], ice: true,
        terrain: [[0,160,72,24],[104,128,32,12],[168,104,32,12],[232,80,40,16],[120,56,40,12],[40,40,48,16],[200,24,48,16]],
        spikes: [[72,152,2,'up'],[176,96,2,'up'],[240,72,2,'up'],[48,32,2,'up']],
        wind: [0,16,320,130,-1,46],
        feather: [16,140],
        berries: [[288,60,'summit-secret-aurora']],
    ...
    'summit-final': {
        ...
        terrain: [[0,160,72,24],[128,160,40,24],[224,160,96,24],[40,128,32,32],[112,104,32,24],[176,80,32,24],[240,56,80,24],[176,32,32,16],[96,8,48,16],[16,48,24,16]],
        spikes: [[48,152,3,'up'],[128,152,2,'up'],[40,120,2,'up'],[112,96,2,'up'],[176,80,2,'left'],[240,48,3,'up']],
        movers: [[72,112,24,8,88,112,50],[144,72,24,8,176,72,52]],
        cassette: [20,34,'cassette-summit','summit2'],
        exit: [120,0,'core']
    },

    // Core: short safe pads, spring commitments, and hot moving relays.
    core: {
        name: 'Core - Threshold', spawn: [16,146],
        terrain: [[0,160,72,24],[128,160,40,24],[224,160,96,24],[32,128,40,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[176,32,40,16],[88,8,48,16],[16,72,24,16]],
        spikes: [[48,152,3,'up'],[128,152,2,'up'],[32,120,2,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        springs: [[48,120,1]], bubbles: [[232,60,9,'#ff8b61']],
        berries: [[24,56,'core-secret-vent']],
        exit: [112,0,'core-furnace']
    },
    'core-furnace': {
        name: 'Core - Magma Conduit', spawn: [16,146],
        terrain: [[0,160,60,24],[132,160,40,24],[236,160,84,24],[76,126,28,18],[188,110,32,16],[268,92,32,16],[120,70,32,16],[204,16,32,16],[288,44,32,16],[48,72,24,16]],
        spikes: [[36,152,2,'up'],[148,152,2,'up'],[84,118,2,'up'],[128,62,2,'up']],
        kevin: [[152,128,24,24],[40,96,24,24]], bubbles: [[252,74,9,'#ff8b61']],
        exit: [212,0,'core-depths']
    },
    'core-depths': {
        spawn: [16,146],
        terrain: [[0,160,64,24],[112,160,40,24],[216,160,104,24],[24,128,32,32],[104,104,32,24],[176,80,32,24],[248,56,72,24],[176,32,32,16],[88,8,48,16],[280,112,24,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,2,'up'],[104,96,2,'up'],[176,80,2,'left'],[248,48,3,'up']],
        movers: [[64,112,24,8,80,112,48],[136,72,24,8,168,72,50]], bubbles: [[232,54,9,'#ff8b61']], kevin: [[256,56,24,24]],
        triggerSpikes: [[136,152,2],[240,152,2]],
        berries: [[288,96,'core-secret-coolant']],
        exit: [112,0,'core-escape']
    },
    'core-escape': {
        spawn: [16,146],
        terrain: [[0,160,72,24],[128,160,40,24],[224,160,96,24],[40,128,32,32],[112,104,32,24],[176,80,32,24],[240,56,80,24],[176,32,32,16],[96,8,48,16],[272,40,32,16]],
        spikes: [[48,152,3,'up'],[128,152,2,'up'],[40,120,2,'up'],[112,96,2,'up'],[176,72,2,'up'],[240,48,3,'up']],
        bubbles: [[216,62,9,'#ff8b61']], badelines: [[280,120]],
        cassette: [280,26,'cassette-core','core2'],
        exit: [120,0,'farewell']
    },

    // Farewell: focused mechanic pairs, then a short final endurance chain.
    farewell: {
        name: 'Farewell - Departure', spawn: [16,146],
        terrain: [[0,160,56,24],[120,160,40,24],[224,160,96,24],[24,128,32,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[184,32,32,16],[96,8,48,16],[16,72,24,16]],
        spikes: [[32,152,3,'up'],[120,152,2,'up'],[24,120,2,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        bubbles: [[80,116,9,'#78ffe1'],[160,84,9,'#78ffe1'],[236,52,9,'#78ffe1']],
        berries: [[24,56,'farewell-secret-departure']],
        exit: [120,0,'farewell-eventide']
    },
    'farewell-eventide': {
        spawn: [16,146],
        terrain: [[0,160,64,24],[112,160,40,24],[216,160,104,24],[24,128,32,32],[104,104,32,24],[176,80,32,24],[248,56,72,24],[176,32,32,16],[88,8,48,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,2,'up'],[104,96,2,'up'],[176,80,2,'left'],[248,48,3,'up']],
        movers: [[64,112,24,8,80,112,52],[136,72,24,8,168,72,54]], wind: [40,24,248,120,-1,44],
        exit: [112,0,'farewell-approach']
    },
    'farewell-approach': {
        spawn: [16,146], ice: true,
        terrain: [[0,160,56,24],[112,160,40,24],[216,160,104,24],[24,128,32,32],[104,104,32,24],[176,80,32,24],[248,56,72,24],[176,32,32,16],[88,8,48,16],[280,112,24,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,120,2,'up'],[104,96,2,'up'],[176,72,2,'up'],[248,48,3,'up']],
        bubbles: [[80,112,9,'#7effe4'],[152,76,9,'#7effe4'],[224,44,9,'#7effe4']], wind: [40,24,248,120,-1,50],
        berries: [[288,96,'farewell-secret-moon']],
        exit: [112,0,'farewell-final']
    },
    'farewell-final': {
        spawn: [16,146], ice: true,
        terrain: [[0,160,48,24],[104,160,40,24],[208,160,112,24],[24,128,24,32],[96,104,24,24],[168,80,24,24],[240,56,80,24],[168,32,32,16],[80,8,48,16],[280,112,24,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,96,2,'up'],[168,72,2,'up'],[240,48,4,'up']],
        movers: [[48,120,16,8,80,120,58],[120,88,16,8,152,88,60],[192,48,16,8,224,48,60]],
        bubbles: [[72,110,9,'#78ffe1'],[152,70,9,'#78ffe1'],[224,38,9,'#78ffe1']], wind: [32,16,264,128,-1,54],
        berries: [[288,96,'farewell-secret-last-breath',{golden:true}]],
        exit: [104,0,'summit-peak']
    },
    'summit-peak': {
        spawn: [16,146], ice: true,
        terrain: [[0,160,64,24],[112,160,48,24],[216,160,104,24],[24,128,40,32],[112,104,32,24],[184,80,32,24],[256,56,64,24],[176,32,40,16],[88,8,48,16]],
        spikes: [[40,152,3,'up'],[112,152,2,'up'],[24,120,3,'up'],[112,96,2,'up'],[184,72,2,'up'],[256,48,3,'up']],
        heartGem: [184,16]
    },

    // Optional B-sides: short, dense mastery chains with no strawberries.
    'forsaken-bside': {
        spawn: [16,146],
        terrain: [[0,160,56,24],[112,160,40,24],[208,160,112,24],[24,120,32,40],[104,96,24,24],[176,72,24,24],[248,48,72,24],[176,24,24,16],[88,8,40,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,112,3,'up'],[104,88,2,'up'],[176,64,2,'up'],[248,40,4,'up']],
        movers: [[56,128,16,8,96,128,54],[128,88,16,8,160,88,56]],
        exit: [108,0,'forsaken-bside2']
    },
    'forsaken-bside2': {
        spawn: [16,146],
        terrain: [[0,160,48,24],[104,160,32,24],[200,160,120,24],[24,128,24,32],[96,96,24,24],[168,64,24,24],[240,32,80,24],[144,8,40,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,88,2,'up'],[168,56,2,'up'],[240,24,4,'up']],
        movers: [[48,120,16,8,88,120,58],[128,80,16,8,152,80,60]], wind: [40,24,240,120,-1,34],
        gate: [[52,116,40,8]],
        switches: [[8,96,[[52,116]]]],
        exit: [168,0,'forsaken']
    },
    'old-site2': {
        name: 'Old Site B-Side - Lucid', spawn: [16,146],
        terrain: [[0,160,56,24],[112,160,32,24],[208,160,112,24],[24,120,32,40],[104,96,24,24],[176,72,24,24],[248,48,72,24],[176,24,24,16],[88,8,40,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,112,3,'up'],[104,88,2,'up'],[176,64,2,'up'],[248,40,4,'up']],
        dream: [[64,112,24,16],[136,80,24,16],[208,48,24,16]], movers: [[56,128,16,8,96,128,54]],
        exit: [108,0,'old-site-bside2']
    },
    'old-site-bside2': {
        spawn: [16,146],
        terrain: [[0,160,48,24],[104,160,32,24],[200,160,120,24],[24,128,24,32],[96,96,24,24],[168,64,24,24],[240,32,80,24],[144,8,40,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,88,2,'up'],[168,56,2,'up'],[240,24,4,'up']],
        movers: [[48,120,16,8,88,120,58],[128,80,16,8,152,80,60]],
        badelines: [[280,112]], bubbles: [[148,76,9,'#a879ff']],
        dream: [[64,112,24,16],[136,80,24,16]],
        exit: [168,0,'old-site']
    },
    'resort-bside': {
        spawn: [16,146],
        terrain: [[0,160,56,24],[112,160,32,24],[208,160,112,24],[24,120,32,40],[104,96,24,24],[176,72,24,24],[248,48,72,24],[176,24,24,16],[88,8,40,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,112,1,'up'],[104,88,2,'up'],[176,64,2,'up'],[248,40,4,'up']],
        springs: [[40,112,2]], movers: [[56,128,16,8,96,128,58],[128,88,16,8,160,88,60]],
        exit: [108,0,'resort-bside2']
    },
    'resort-bside2': {
        spawn: [16,146],
        terrain: [[0,160,48,24],[104,160,32,24],[200,160,120,24],[24,128,24,32],[96,96,24,24],[168,64,24,24],[240,32,80,24],[144,8,40,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,88,2,'up'],[168,56,2,'up'],[240,24,4,'up']],
        movers: [[48,120,16,8,88,120,60],[128,80,16,8,152,80,62]], bubbles: [[220,44,9,'#66ffd0']],
        exit: [168,0,'resort']
    },
    'mirror-bside': {
        spawn: [16,146],
        terrain: [[0,160,56,24],[112,160,32,24],[208,160,112,24],[24,120,32,40],[104,96,24,24],[176,72,24,24],[248,48,72,24],[176,24,24,16],[88,8,40,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,112,3,'up'],[104,88,2,'up'],[176,64,2,'up'],[248,40,4,'up']],
        bubbles: [[80,112,9,'#aa82ff'],[152,76,9,'#aa82ff'],[224,40,9,'#aa82ff']], seekers: [[280,112]],
        exit: [108,0,'mirror-bside2']
    },
    'mirror-bside2': {
        spawn: [16,146],
        terrain: [[0,160,48,24],[104,160,32,24],[200,160,120,24],[24,128,24,32],[96,96,24,24],[168,64,24,24],[240,32,80,24],[144,8,40,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,88,2,'up'],[168,56,2,'up'],[240,24,4,'up']],
        bubbles: [[76,116,9,'#aa82ff'],[148,76,9,'#aa82ff'],[220,40,9,'#aa82ff']], badelines: [[280,112]],
        triggerSpikes: [[112,152,2],[232,152,3]],
        exit: [168,0,'mirror']
    },
    summit2: {
        name: 'The Summit B-Side - Thin Air', spawn: [16,146], ice: true,
        terrain: [[0,160,56,24],[112,160,32,24],[208,160,112,24],[24,120,32,40],[104,96,24,24],[176,72,24,24],[248,48,72,24],[176,24,24,16],[88,8,40,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,112,3,'up'],[104,88,2,'up'],[176,64,2,'up'],[248,40,4,'up']],
        movers: [[56,128,16,8,96,128,60],[128,88,16,8,160,88,62]], wind: [40,24,248,120,-1,42],
        exit: [108,0,'summit3']
    },
    summit3: {
        name: 'The Summit C-Side - Whiteout', spawn: [16,146], ice: true,
        terrain: [[0,160,48,24],[104,160,32,24],[200,160,120,24],[24,128,24,32],[96,96,24,24],[168,64,24,24],[240,32,80,24],[144,8,40,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,88,2,'up'],[168,56,2,'up'],[240,24,4,'up']],
        bubbles: [[76,116,9,'#d9fbff'],[148,76,9,'#d9fbff'],[220,40,9,'#d9fbff']], wind: [32,16,264,128,-1,52],
        exit: [168,0,'summit']
    },
    core2: {
        name: 'Core B-Side - Overheat', spawn: [16,146],
        terrain: [[0,160,56,24],[112,160,32,24],[208,160,112,24],[24,120,32,40],[104,96,24,24],[176,72,24,24],[248,48,72,24],[176,24,24,16],[88,8,40,16]],
        spikes: [[32,152,3,'up'],[112,152,2,'up'],[24,112,3,'up'],[104,88,2,'up'],[176,64,2,'up'],[248,40,4,'up']],
        movers: [[56,128,16,8,96,128,62],[128,88,16,8,160,88,64]], bubbles: [[224,44,9,'#ff8b61']],
        exit: [108,0,'core-bside2']
    },
    'core-bside2': {
        spawn: [16,146],
        terrain: [[0,160,48,24],[104,160,32,24],[200,160,120,24],[24,128,24,32],[96,96,24,24],[168,64,24,24],[240,32,80,24],[144,8,40,16]],
        spikes: [[24,152,3,'up'],[104,152,2,'up'],[24,120,2,'up'],[96,88,2,'up'],[168,56,2,'up'],[240,24,4,'up']],
        movers: [[48,120,16,8,88,120,64],[128,80,16,8,152,80,66]], bubbles: [[76,112,9,'#ff8b61'],[220,40,9,'#ff8b61']],
        kevin: [[192,120,24,24]],
        exit: [168,0,'core']
    }
};
